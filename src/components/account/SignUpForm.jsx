  ...
  return (
    // <div className="flex flex-col gap-6">
      <div className="w-full h-full min-h-screen flex items-center justify-center p-4">
       ...
       <h1 className="animate-element animate-delay-100 text-4xl md:text-2xl font-semibold leading-tight">Kayıt Ol</h1>
        ...
        <div className="flex-1 p-8 flex flex-col justify-center">
          ...
          <div className="animate-element animate-delay-700 relative flex items-center justify-center my-4">
            ...
            <span className="px-4 text-sm text-muted-foreground bg-white absolute">Ya da</span>
          </div>

          <button
          // onClick={onGoogleSignIn}
            className="animate-element animate-delay-800 w-full flex items-center justify-center text-black gap-3 border border-border rounded-2xl py-4 hover:bg-secondary transition-colors">
